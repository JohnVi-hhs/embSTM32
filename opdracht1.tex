...
Open in Windows een terminal (b.v. een PowerShell, cmd prompt of een extern programma zoals b.v. KiTTY). We gebruiken voor nu PowerShell: Ga naar Windows Search: druk Windows+S (de knop met het Windows vlaggetje + de 'S'), zie Figuur \ref{fig:windowsZk} en
\begin{figure}[h!]
	\centering
	\begin{center} 	
...
\begin{itemize}
	\item Selecteer de file test.cpp en compileer de files\footnote{compileren lukt niet, controleer of c++ extension (\img{figuren/cPlusIcon} ) is geinstalleerd} (Terminal $\rightarrow$ Run Build Task... of Cntrl+Shift+B) 
