...
Bij deze opdracht kijken we hoe bij OO componenten, Overerving en Polymorfisme getest kunnen worden met een debugger.
...
\begin{itemize}
	...
	\item Plaats een breakpoint op regel 21 van Listing \ref{lst:mainSled} ({\small \texttt{ LedInfo(led1) }}).
