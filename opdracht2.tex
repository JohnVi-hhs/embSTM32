...
git clone \verb|--|branch opdracht31 https://github.com/JohnVi-hhs/oop.git
\item
...
\texttt{Hi NSE, welkom bij opdracht 2\\
Informatie ove de RGBLed:\\
De eigenaar is:Pietje Puk\\
De Led is aangesloten op pinnen:146 149 146\\
De status van de Led is:1\\
Informatie ove de SingleLed:\\
De eigenaar is:Pietje\\
De Led is aangesloten op pinnen:135\\
De status van de Led is:0\\
einde}
\item Start de vnc viewer, open een terminal, ga naar de directory waar de code van Listing \ref{lst:mainCombi} staat en run de DDD debugger. (ddd test)
\begin{enumerate}[label=(\roman*)]
	\item Zet een breakpoint op de regel\texttt{ LedInfo(kleuren);}(regel 21 van Listing \ref{lst:mainCombi}) 
